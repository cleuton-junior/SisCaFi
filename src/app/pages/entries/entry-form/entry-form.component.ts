...
export class EntryFormComponent implements OnInit, AfterContentChecked {
  ...
  ptBR =  {
    firstDayOfWeek: 0,
            ...
            monthNames: [ "Janeiro","Fevereiro","Março","Abril","Maio","Junho","Jullo","Agosto","Setembro","Outubro","Novembro","Dezembro" ],
  ...
  private setPageTitle(){
    if(this.currentAction == 'new')
      ...
      const entryName = this.entry.name || '' // const created to prevent entry name from coming empty
